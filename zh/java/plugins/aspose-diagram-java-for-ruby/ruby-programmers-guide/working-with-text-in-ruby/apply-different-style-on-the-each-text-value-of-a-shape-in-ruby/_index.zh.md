---
title: 在 Ruby 中对形状的每个文本值应用不同的样式
type: docs
weight: 20
url: /zh/java/apply-different-style-on-the-each-text-value-of-a-shape-in-ruby/
---
## **Aspose.Diagram - 对形状的每个文本值应用不同的样式**
要在形状的每个文本值上应用不同的样式，请使用**Aspose.Diagram Java 红宝石** 只需调用**添加形状文本和样式**模块。在这里您可以看到示例代码。
