---
title: Wenden Sie einen anderen Stil auf die einzelnen Textwerte einer Form in PHP an
type: docs
weight: 20
url: /de/java/apply-different-style-on-the-each-text-value-of-a-shape-in-php/
---
## **Aspose.Diagram – Wenden Sie einen anderen Stil auf die einzelnen Textwerte einer Form an**
 So wenden Sie einen anderen Stil auf die einzelnen Textwerte einer Form an**Aspose.Diagram Java für PHP** , einfach aufrufen**AddShapeTextAndStyles** Modul. Hier sehen Sie Beispielcode.
