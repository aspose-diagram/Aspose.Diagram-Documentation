---
title: Wenden Sie in Ruby einen anderen Stil auf die einzelnen Textwerte einer Form an
type: docs
weight: 20
url: /de/java/apply-different-style-on-the-each-text-value-of-a-shape-in-ruby/
---
## **Aspose.Diagram – Wenden Sie einen anderen Stil auf die einzelnen Textwerte einer Form an**
 So wenden Sie einen anderen Stil auf die einzelnen Textwerte einer Form an**Aspose.Diagram Java für Rubin** , einfach aufrufen**AddShapeTextAndStyles** Modul. Hier sehen Sie Beispielcode.
...
## **Laufcode herunterladen**
 Download**Anwenden eines anderen Stils auf die einzelnen Textwerte einer Form (Aspose.Diagram)**von einer der unten genannten Social-Coding-Sites:
