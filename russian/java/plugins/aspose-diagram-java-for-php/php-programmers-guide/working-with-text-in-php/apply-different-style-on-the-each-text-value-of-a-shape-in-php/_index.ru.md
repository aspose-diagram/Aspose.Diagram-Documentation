---
title: Применение разных стилей к каждому текстовому значению формы в PHP
type: docs
weight: 20
url: /ru/java/apply-different-style-on-the-each-text-value-of-a-shape-in-php/
---
## **Aspose.Diagram — Применение разных стилей к каждому текстовому значению фигуры**
 Чтобы применить другой стиль к каждому текстовому значению фигуры, используя**Aspose.Diagram Java для PHP** , просто вызовите**Аддшапетекстандстилес** модуль. Здесь вы можете увидеть пример кода.
...
- [Гитхаб](https://github.com/asposediagram/Aspose.Diagram-for-Java/blob/master/Plugins/Aspose_Diagram_Java_for_PHP/src/aspose/diagram/WorkingwithText/AddShapeTextAndStyles.php)
