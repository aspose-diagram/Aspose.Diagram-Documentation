---
title: Insérer une nouvelle page vierge dans un dessin Visio en PHP
type: docs
weight: 20
url: /fr/java/insert-a-new-blank-page-into-a-visio-drawing-in-php/
---
## **Aspose.Diagram - Insérer une nouvelle page vierge dans un dessin Visio**
 Pour insérer une nouvelle page vierge dans un dessin Visio à l'aide de**Aspose.Diagram Java pour PHP** , invoquez simplement**Ajouter une page** module. Ici vous pouvez voir un exemple de code.
