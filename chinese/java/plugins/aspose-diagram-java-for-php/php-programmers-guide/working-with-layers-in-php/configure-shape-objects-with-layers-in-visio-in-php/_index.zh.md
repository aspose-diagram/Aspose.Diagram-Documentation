---
title: 在 Visio 中用 PHP 配置带图层的形状对象
type: docs
weight: 10
url: /zh/java/configure-shape-objects-with-layers-in-visio-in-php/
---
## **Aspose.Diagram - 使用图层配置形状对象**
使用层配置形状对象**Aspose.Diagram Java 用于 PHP** 只需调用**ConfigureShapeWithLayers**模块。在这里您可以看到示例代码。
