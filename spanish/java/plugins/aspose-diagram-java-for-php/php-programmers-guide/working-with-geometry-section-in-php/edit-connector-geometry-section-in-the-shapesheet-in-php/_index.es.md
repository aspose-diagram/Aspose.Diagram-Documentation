---
title: Edite la sección de geometría del conector en ShapeSheet en PHP
type: docs
weight: 10
url: /es/java/edit-connector-geometry-section-in-the-shapesheet-in-php/
---
## **Aspose.Diagram - Editar la sección de geometría del conector en ShapeSheet**
 Para editar la sección de geometría del conector en ShapeSheet usando**Aspose.Diagram Java para PHP** , simplemente invocar**FormaGeometríaSección** módulo. Aquí puedes ver el código de ejemplo.
