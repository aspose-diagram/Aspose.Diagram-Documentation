---
title: Appliquer un style différent sur chaque valeur de texte d'une forme en PHP
type: docs
weight: 20
url: /fr/java/apply-different-style-on-the-each-text-value-of-a-shape-in-php/
---
## **Aspose.Diagram - Appliquer un style différent sur chaque valeur de texte d'une forme**
 Pour appliquer un style différent sur chaque valeur de texte d'une forme à l'aide**Aspose.Diagram Java pour PHP** , invoquez simplement**AjouterFormeTexteEtStyles** module. Ici vous pouvez voir un exemple de code.
