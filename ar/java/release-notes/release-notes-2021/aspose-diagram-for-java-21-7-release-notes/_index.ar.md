---
title: Aspose.Diagram for Java 21.7 ملاحظات الإصدار
type: docs
weight: 6
url: /ar/java/aspose-diagram-for-java-21-7-release-notes/
---
{{% alert color="primary" %}}

تحتوي هذه الصفحة على معلومات حول ملاحظات الإصدار Aspose.Diagram for Java 21.7.
