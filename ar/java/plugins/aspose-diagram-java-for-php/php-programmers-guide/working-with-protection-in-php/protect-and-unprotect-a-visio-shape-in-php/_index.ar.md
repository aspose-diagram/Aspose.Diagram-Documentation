---
title: حماية وإلغاء حماية شكل Visio في PHP
type: docs
weight: 10
url: /ar/java/protect-and-unprotect-a-visio-shape-in-php/
---
## **Aspose.Diagram - حماية وإلغاء حماية شكل Visio**
 لحماية شكل Visio وإلغاء حمايته باستخدام**Aspose.Diagram Java لـ PHP** ، ببساطة استدعاء**ProtectUnprotectShape** وحدة. هنا يمكنك أن ترى رمز المثال.
...
- [جيثب](https://github.com/asposediagram/Aspose.Diagram-for-Java/blob/master/Plugins/Aspose_Diagram_Java_for_PHP/src/aspose/diagram/WorkingwithProtection/ProtectUnprotectShape.php)
