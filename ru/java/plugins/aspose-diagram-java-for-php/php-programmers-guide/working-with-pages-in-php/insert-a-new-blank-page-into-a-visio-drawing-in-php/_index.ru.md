---
title: Вставьте новую пустую страницу в рисунок Visio в PHP
type: docs
weight: 20
url: /ru/java/insert-a-new-blank-page-into-a-visio-drawing-in-php/
---
## **Aspose.Diagram — вставить новую пустую страницу в чертеж Visio**
 Чтобы вставить новую пустую страницу в чертеж Visio с помощью**Aspose.Diagram Java для PHP** , просто вызовите**Добавить страницу** модуль. Здесь вы можете увидеть пример кода.
...
- [Гитхаб](https://github.com/asposediagram/Aspose.Diagram-for-Java/blob/master/Plugins/Aspose_Diagram_Java_for_PHP/src/aspose/diagram/WorkingwithPages/AddPage.php)
