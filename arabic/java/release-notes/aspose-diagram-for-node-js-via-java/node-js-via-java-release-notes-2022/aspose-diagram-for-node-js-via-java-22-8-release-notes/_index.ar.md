---
title: Aspose.Diagram لـ Node.js عبر Java 22.8 ملاحظات الإصدار
type: docs
weight: 20
url: /ar/java/aspose-diagram-for-node-js-via-java-22-8-release-notes/
---
{{% alert color="primary" %}}

تحتوي هذه الصفحة على معلومات حول ملاحظات الإصدار لـ Aspose.Diagram لـ Node.js عبر Java 22.8.
