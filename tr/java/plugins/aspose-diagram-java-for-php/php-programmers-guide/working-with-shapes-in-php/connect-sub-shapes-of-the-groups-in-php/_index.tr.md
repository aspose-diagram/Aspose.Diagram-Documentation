---
title: PHP'de Grupların Alt Şekillerini Bağlayın
type: docs
weight: 20
url: /tr/java/connect-sub-shapes-of-the-groups-in-php/
---
## **Aspose.Diagram - Grupların Alt Şekillerini Bağla**
 Kullanarak Grupların Alt Şekillerini Bağlamak İçin**PHP için Aspose.Diagram Java** , sadece çağırmak**Alt Şekilleri Bağla** modül. Burada örnek kodu görebilirsiniz.
